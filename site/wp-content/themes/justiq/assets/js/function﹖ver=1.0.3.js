(function ($) {
	...
	if($('.at-animation-heading-style-4 .elementor-heading-title, .at-animation-heading-style-4 .ekit-heading--title').length) {
		var textheading = $('.at-animation-heading-style-4 .elementor-heading-title, .at-animation-heading-style-4 .ekit-heading--title');
	...
	$window.on("elementor/frontend/init", function () {
		elementorFrontend.hooks.addAction("frontend/element_ready/justiq-casestudy-grid.default", casestudy_grid );
	});
	
	/* Why Choose Content Active Start */
	var $why_choose_content = $('.why-choose-content');
	if ($why_choose_content.length) {
		var $why_choose_item = $why_choose_content.find('.why-choose-item');
